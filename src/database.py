...
from src.entities.temp_stock_hq import TempStockHQEntity  # Import TempStockHQEntity

DATABASE_URL = "mysql+pymysql://root:xiaoyi@127.0.0.1:3306/stocks_db"  # 修改为你的MySQL数据库URL
